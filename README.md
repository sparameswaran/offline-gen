...
The motivation of this tool is to alleviate the problem of creating and maintaining manually a different set of pipelines that refer to offlined resources, tracking down and saving the resources into blobstores. Rather use a tool to automatically harvest the resources involved into a s3 blobstore, generate the offline pipeline and run in isolated/offline mode.
